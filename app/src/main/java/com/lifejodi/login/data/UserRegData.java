...
public class UserRegData {
    ...
    public static String PROFILEFORNAME = "user_profile_for";
    ...
    public static String EDUCATIONNAME = "educationlevel";
    ...
    public static String EMPLOYEDINNAME = "workingas";
    ...
    public static String ABOUT_COMMENT = "comment";
