...
public class FragmentRejected extends android.support.v4.app.Fragment {
    ...
    public void setRecyclerAdapter() {
        ...
        recyclerRequestStatus.setAdapter(new RequestStatusAdapter(getActivity(),profilesData.getRejectedList()));
